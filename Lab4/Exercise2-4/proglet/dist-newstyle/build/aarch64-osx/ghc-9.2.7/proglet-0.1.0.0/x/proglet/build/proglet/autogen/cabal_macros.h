...
/* package proglet-0.1.0.0 */
#ifndef VERSION_proglet
#define VERSION_proglet "0.1.0.0"
#endif /* VERSION_proglet */
#ifndef MIN_VERSION_proglet
#define MIN_VERSION_proglet(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_proglet */
...
#define CURRENT_COMPONENT_ID "proglet-0.1.0.0-inplace-proglet"
