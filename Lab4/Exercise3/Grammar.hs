...
happyExpList = Happy_Data_Array.listArray (0,43) ([480,257,0,32,64,3072,3072,0,15361,57376,257,4352,2176,0,0,0,0,0,0,0,3840,8,49160,515,0,4608,1920,4,4,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_parseCalc","Exp","Dir","Forward","Rotate","Check","If","Then","Else","L","R","';'","digit","int","'('","')'","%eof"]
...
action_5 (13) = happyShift action_14
...
happyNewToken action sts stk (tk:tks) =
	...
	TokenElse _ -> cont 11;
	TokenLeft _ -> cont 12;
	TokenRight _ -> cont 13;
	TokenSeq _ -> cont 14;
	TokenDigit _ happy_dollar_dollar -> cont 15;
...
happyError' :: () => ([(MDLToken)], [Prelude.String]) -> HappyIdentity a
...
parseError (t:ts) = error $ "Parse error at " ++ show (tokenPosn t) ++ "\n"
